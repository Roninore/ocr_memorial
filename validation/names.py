...
def load_names_from_json() -> list:
    """Прочитать базу имен из JSON базы"""
...
def load_surnames_from_json() -> list:
    """Прочитать базу фамилий из JSON базы"""
...
def load_patronymics_from_json() -> list:
    """Прочитать базу отчеств из JSON базы"""
    partonymics = []
...
surnames = load_surnames_from_json()
partonymics = load_patronymics_from_json()

def validate_name(name: str) -> str:
    """Проверка имени"""
    return validate_fullname_part(name,names)

def validate_surname(surname: str) -> str:
    """Проверка фамилии"""
    return validate_fullname_part(surname,surnames)

def validate_partonymic(patronymic: str) -> str:
    """Проверка отчества"""
    return validate_fullname_part(patronymic,partonymics)


def validate_fullname_part(name_part: str, db_list: list) -> str:
...
def get_name(raw_string: str='') -> str:
    ...
    try:
        ...
        filtered[SURNAME_ID] = validate_surname(filtered[SURNAME_ID])
        filtered[NAME_ID] = validate_name(filtered[NAME_ID])
        filtered[PATRONYMIC_ID] = validate_partonymic(filtered[PATRONYMIC_ID])
